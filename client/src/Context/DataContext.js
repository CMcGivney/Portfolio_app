...
sipNStir = new ProjectsData(SipNStir, "Sip And Stir Park City, Utah Homepage", "Sip And Stir Park City Business", "I built this site for a friend who is starting a new business. I built this using react-sematic-ui, React, and a static Express server, hosted with Heroku. I am currently working as the site manager and google business site manager. Exploring optimization strategies with Google Console, and other tools, while refactoring the sites code when needed.", "https://www.sipandstirpc.com")
projectData.push(sipNStir)

absSite = new ProjectsData(ABSSite, "ABS Seafood Slc, Utah Homepage", "ABS Seafood SLC Business Website", "I built this using react-sematic-ui, React, and a static Express server, hosted with Heroku. I enjoyed styling this after the parent companies website that had recently been remodeled. I am currently working as the site manager and google business site manager. Exploring optimization strategies with Google Console, and other tools, while refactoring the sites code when needed.", "https://www.absseafoodutah.com")
